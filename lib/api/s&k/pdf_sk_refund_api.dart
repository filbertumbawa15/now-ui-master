...
class PdfSKRefundApi {
  static Future<File> generate(SyaratKetentuanRefund syaratKetentuan) async {
    final pdf = Document();
    final imageJpg =
    ...
    return PdfApi.saveDocument(
        name: 'Bukti-Refund ${syaratKetentuan.nobukti}.pdf', pdf: pdf);
  }
  ...
  static Widget buildCustomerAddress(SyaratKetentuanRefund syaratKetentuan) =>
      Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
  ...
  static Widget buildTgl(SyaratKetentuanRefund syaratKetentuan) => Column(
  ...
  static Widget buildTitle(SyaratKetentuanRefund syaratKetentuan) => Row(
        crossAxisAlignment: CrossAxisAlignment.start,
  ...
  static Widget buildPengirim(SyaratKetentuanRefund syaratKetentuan) {
    final headers = [
